...
const NISTChecklist = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <Helmet>
        <title>Free NIST AI RMF Compliance Checklist | Autom8ion Lab</title>
        <meta
          name="description"
          content="Download the NIST AI Risk Management Framework compliance checklist. 96 auditable items, evidence requirements, and a scoring system across GOVERN, MAP, MEASURE, and MANAGE."
        />
        <meta name="robots" content="noindex, nofollow" />
        <link rel="canonical" href={getCanonicalUrl('/nist-checklist')} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Free NIST AI RMF Compliance Checklist | Autom8ion Lab" />
        <meta
          property="og:description"
          content="96 auditable items, evidence requirements, and a scoring system to assess your AI governance posture — free from Autom8ion Lab."
        />
        <meta property="og:url" content="https://autom8ionlab.com/nist-checklist" />
        ...
        <meta name="twitter:title" content="Free NIST AI RMF Compliance Checklist | Autom8ion Lab" />
        <meta
