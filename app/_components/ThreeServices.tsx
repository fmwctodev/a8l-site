          ...
          {services.map((service) => {
            ...
            return (
              <Link
                ...
                className="group bg-slate-900/50 border border-slate-800 rounded-xl p-8 hover:border-cyan-500/40 transition-all duration-300 flex flex-col"
              >
                <div
                  className={`w-12 h-12 rounded-lg bg-gradient-to-br ${service.accent} flex items-center justify-center mb-5`}
                >
