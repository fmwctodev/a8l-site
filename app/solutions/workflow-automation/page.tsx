...
export const metadata: Metadata = {
  title: 'Workflow Automation for Federal, DIB, Healthcare & Financial Services',
  description: 'Secure workflow and process automation for US Federal, DIB, healthcare, and financial services teams. Multi-step approval workflows, private-network AI agents, and RPA aligned to FedRAMP, NIST 800-53, and FISMA. Live in 30 days.',
  keywords: 'workflow automation, FedRAMP automation, NIST 800-53 workflow, FISMA automation, DIB workflow automation, private network AI agents, RPA controlled environments, multi-step approval workflows, audit trail automation, SDVOSB',
  alternates: { canonical: 'https://autom8ionlab.com/solutions/workflow-automation' },
  openGraph: {
    title: 'Workflow Automation for Federal, DIB, Healthcare & Financial Services | Autom8ion Lab',
    description: 'Secure, professional-grade workflow and process automation for regulated environments. Multi-step approval workflows, private-network AI agents, RPA — aligned to FedRAMP, NIST 800-53, and FISMA. SDVOSB Pending.',
    url: 'https://autom8ionlab.com/solutions/workflow-automation',
    images: [{ url: 'https://autom8ionlab.com/logo/logo.png', width: 1200, height: 630 }],
  },
  twitter: {
    title: 'Workflow Automation for Federal, DIB, Healthcare & Financial Services | Autom8ion Lab',
    description: 'Secure workflow and process automation for regulated environments. Multi-step approvals, private-network AI agents, RPA — aligned to FedRAMP, NIST 800-53, and FISMA.',
  },
};
              ...
              <div className="relative z-10 flex items-center justify-center min-h-[80vh] px-6">
                <div className="max-w-6xl mx-auto text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <Link href="/get-in-touch" className="group bg-gradient-to-r from-purple-600 to-cyan-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/25 flex items-center space-x-2">
            ...
            <section className="py-24 bg-black relative">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                  ...
                  <Link href="/get-in-touch" className="bg-gradient-to-r from-purple-600 to-cyan-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105">
            ...
            <section className="py-24 bg-black relative">
              <div className="max-w-7xl mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <p className="text-lg text-slate-300 mb-6 leading-relaxed">
                    Most agencies sell access to a platform they did not build and cannot secure for your environment. We take a different approach. We build workflow and process automation on infrastructure you control because regulated operations demand control, traceability, and isolation. Most engagements ship in 8&ndash;14 weeks; CMMC remediation runs 4&ndash;9 months; FedRAMP-aligned builds run 6+ months. Process audit and control mapping comes first, build and engineering second, validation and deployment third. We don't just build the happy path — we build access controls, logging, retry logic, and exception handling so the system performs under real operational pressure.
                  </p>
                  <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                    We are veteran-owned with SDVOSB certification pending, registered as a US federal contractor (UEI: YY2DR3KSENH7, CAGE: 9YCS7, DUNS: 05-289-2750). Our work targets concrete operational outcomes — hours saved, approval cycle time reduced, compliance evidence captured automatically — measured against your existing baseline during scoping. Systems scale from 100 tasks a day to 100,000 without sacrificing traceability or control, aligned to NIST 800-53, FISMA, and FedRAMP-aligned cloud expectations.
                  </p>
                  <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50">
                    ...
                    <Link href="/get-in-touch" className="inline-block bg-gradient-to-r from-purple-600 to-cyan-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105">
