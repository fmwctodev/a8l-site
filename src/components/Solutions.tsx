      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-6">
            AI Automation, <Link to="/solutions/cloud-systems" className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-300 hover:to-cyan-300 transition-colors">Cloud Infrastructure</Link> & <Link to="/solutions/cybersecurity" className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-amber-400 hover:from-cyan-300 hover:to-amber-300 transition-colors">Cybersecurity</Link> Built for Your Business
          </h2>
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            We build <Link to="/solutions/ai-agent-development" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">AI agents</Link>, <Link to="/solutions/cloud-systems" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">cloud systems</Link>, <Link to="/solutions/cybersecurity" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">cybersecurity</Link>, and <Link to="/solutions/data-management" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">data management</Link> solutions that fit your specific business needs. No generic templates.
          </p>
        </div>
