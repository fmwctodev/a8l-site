...
export const metadata: Metadata = {
  title: 'Thank You',
  description: 'Thank you for your request. We\'re sending your capabilities statement to your email address right now.',
  alternates: { canonical: 'https://autom8ionlab.com/thank-you' },
