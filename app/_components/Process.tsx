      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-4">
            Speed doesn't mean cutting corners. We use proven frameworks and modular building blocks to deliver custom <Link href="/solutions/workflow-automation" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">workflow automation</Link>, <Link href="/solutions/custom-llm-systems" className="text-cyan-400 hover:text-cyan-300 underline transition-colors">LLM systems</Link>, and enterprise solutions in weeks.
          </p>
