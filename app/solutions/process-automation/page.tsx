...
import { Settings, Zap, Activity, TrendingUp, CheckCircle, ArrowRight, Cpu, GitMerge, Workflow } from 'lucide-react';
import CTA from '@/app/_components/CTA';
import RelatedSolutions from '@/app/_components/RelatedSolutions';

export const metadata: Metadata = {
  title: 'Process Automation for Compliance-Heavy Industries',
  description: 'Framework-anchored process automation for US Federal, DIB, healthcare, and financial services. Custom integrations between internal systems and regulated platforms aligned to FedRAMP, NIST 800-53, and FISMA. SDVOSB Pending. Live in 30 days.',
  keywords: 'federal process automation, FedRAMP RPA, NIST 800-53 automation, FISMA process automation, DIB workflow automation, compliance-heavy automation, regulated industry RPA, audit-ready automation, SDVOSB automation, custom integration federal',
  alternates: { canonical: 'https://autom8ionlab.com/solutions/process-automation' },
  openGraph: {
    title: 'Process Automation for Compliance-Heavy Industries | Autom8ion Lab',
    description: 'Framework-anchored automation for federal, DIB, healthcare, and financial services. Custom integrations aligned to FedRAMP, NIST 800-53, and FISMA. SDVOSB Pending — UEI: YY2DR3KSENH7.',
    url: 'https://autom8ionlab.com/solutions/process-automation',
    images: [{ url: 'https://autom8ionlab.com/logo/logo.png', width: 1200, height: 630 }],
  },
  twitter: {
    title: 'Process Automation Software | RPA & AI-Driven Efficiency | Autom8ion Lab',
    description: 'Automate repetitive tasks and optimize workflows with AI and RPA. Improve accuracy, reduce costs, and scale operations seamlessly with Autom8ion Lab.',
  },
};
              ...
              <div className="relative z-10 flex items-center justify-center min-h-[80vh] px-6">
                <div className="max-w-6xl mx-auto text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <Link href="/get-in-touch" className="group bg-gradient-to-r from-red-600 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-red-700 hover:to-orange-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/25 flex items-center space-x-2">
              ...
              <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mt-12 text-center">
                  <p className="text-slate-300 mb-6 max-w-3xl mx-auto">
                    Integrate seamlessly with <Link href="/solutions/workflow-automation" className="text-orange-400 hover:text-orange-300 underline">workflow automation</Link> for end-to-end process orchestration, <Link href="/solutions/ai-agent-development" className="text-orange-400 hover:text-orange-300 underline">AI agent development</Link> for intelligent decision-making, and <Link href="/solutions/data-management" className="text-orange-400 hover:text-orange-300 underline">data management systems</Link> for insight-driven optimization.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="py-24 bg-black relative">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                  ...
                  <Link href="/get-in-touch" className="bg-gradient-to-r from-red-600 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-red-700 hover:to-orange-600 transition-all duration-300 transform hover:scale-105">
              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50">
                    ...
                    <Link href="/get-in-touch" className="inline-block bg-gradient-to-r from-red-600 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-red-700 hover:to-orange-600 transition-all duration-300 transform hover:scale-105">
